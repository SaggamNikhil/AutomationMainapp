...
Scenario: Verify with the Plot details by CropIncome Dropdown selection details
Given the user signin with the Respective role credential details
Then the page will Navigate to the Dashboard screen of the main pages
Then click on the dashboard menu as Activities module name
And click on the Partial Uprootment screen
...
@PartialUprootment_Data3
Scenario: Verify with the plot details by caretake name input field
Given the user signin with the Respective role credential details
Then the page will Navigate to the Dashboard screen of the main pages
Then click on the dashboard menu as Activities module name
And click on the Partial Uprootment screen
...
@PartialUprootment_Data3
Scenario: Check with the Landmark details
Given the user signin with the Respective role credential details
Then the page will Navigate to the Dashboard screen of the main pages
Then click on the dashboard menu as Activities module name
And click on the Partial Uprootment screen
...
@PartialUprootment_Data3
Scenario: Check with the Click on the Plantation Details grid
Given the user signin with the Respective role credential details
Then the page will Navigate to the Dashboard screen of the main pages
Then click on the dashboard menu as Activities module name
And click on the Partial Uprootment screen
...
@PartialUprootment_Data3
Scenario: Verify with the Sapling Nursery selection
Given the user signin with the Respective role credential details
Then the page will Navigate to the Dashboard screen of the main pages
Then click on the dashboard menu as Activities module name
And click on the Partial Uprootment screen
...
@PartialUprootment_Data3
Scenario: Verify with the Sprouts vendor input details
Given the user signin with the Respective role credential details
Then the page will Navigate to the Dashboard screen of the main pages
Then click on the dashboard menu as Activities module name
And click on the Partial Uprootment screen
...
@PartialUprootment_Data3
Scenario: Verify with the Origin of saplings input selection details
Given the user signin with the Respective role credential details
Then the page will Navigate to the Dashboard screen of the main pages
Then click on the dashboard menu as Activities module name
And click on the Partial Uprootment screen
...
@PartialUprootment_Data5
Scenario: Verify with the Cross Dropdown input selection details
Given the user signin with the Respective role credential details
Then the page will Navigate to the Dashboard screen of the main pages
Then click on the dashboard menu as Activities module name
And click on the Partial Uprootment screen
...
@partialUprootment_Data3
Scenario: Check with the planted saplings input details
Given the user signin with the Respective role credential details
Then the page will Navigate to the Dashboard screen of the main pages
Then click on the dashboard menu as Activities module name
And click on the Partial Uprootment screen
